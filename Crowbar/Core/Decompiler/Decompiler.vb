...
#Region "Private Methods in Background Thread"
    ...
    Public Property CrowbarApp As App
        Get
            Return TheApp
        End Get
        Set
    ...
    'Public Function InitializeTheApp() As App
    '	Main.TheApp = New App()
    '	InitializeTheApp = Main.TheApp
    'End Function
    ...
    Public Function DecompileOneModel(ByVal mdlPathFileName As String) As AppEnums.StatusMessage
        Dim status As AppEnums.StatusMessage = StatusMessage.Success
